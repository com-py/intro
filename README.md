...
- ### To run a program online in Binder: Choose a chapter folder above, then click on a notebook link near the bottom (*Note: server image building/loading may be slow the first time*. Subsequently, programs should run normally, depending on server load.). 
